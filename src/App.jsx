...
export default function App(){
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 md:py-32 bg-[#0b0f10] text-white">
      ...
      <div className="fixed top-4 left-4 px-4 py-2 rounded-xl border border-zinc-800 bg-zinc-900/60 shadow-lg text-sm font-semibold" style={{color: ACCENT}}>
        {NAME}
      </div>
      ...
      <section id="projects" className="mt-32 max-w-4xl w-full px-4">
        ...
        <div className="flex flex-col gap-6">
          ...
          <details className="group rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
            ...
            <div className="mt-4 text-zinc-300">
              <p className="mb-3">Try clicking tiles.</p>
          ...
          <details className="group rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
            ...
            <div className="mt-4 text-zinc-300">
              <button className="px-4 py-2 bg-zinc-800 rounded hover:bg-zinc-700">Generate Orders</button>
            </div>
          </details>
          ...
          <details className="group rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
            ...
            <div className="mt-4 text-zinc-300">
              <button className="px-4 py-2 bg-zinc-800 rounded hover:bg-zinc-700">Toggle Theme</button>
            </div>
          </details>
